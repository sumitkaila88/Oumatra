...
export function Hero(){return <section className="hero" id="top" aria-labelledby="hero-title">
  ...
  <div className="hero__inner frame">
    ...
    <p>A global parent company<br/>that builds and nurtures enduring companies.</p>
    <a className="hero__button" href="#purpose">Discover our purpose <span aria-hidden="true">→</span></a>
  </div>
